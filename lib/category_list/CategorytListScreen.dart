...
class _CategorytListScreenState extends State<CategorytListScreen> {
  ...
  //Future<Autogenerated> _freshProductList;
  ...
  // Future<Autogenerated> _getFreshProducts() async {
  ...
  Future<List<ProductModel>> _getFreshProducts() async {
    //Future<List<Autogenerated>> _getFreshProducts() async {
    print("_getFreshProducts");
    SharedPreferences prefs = await SharedPreferences.getInstance();
    var userID = prefs.getString('user_id');
    //print("userID" + userID.toString());
    print("usertype" + prefs.get("usertype").toString());
    _agentLoad(prefs.get("usertype"));
    // if (prefs.get("usertype").toString() != "null" &&
    //     prefs.get("usertype") == "DI") {
    //   //setState(() {
    //   isAgent = true;
    //   //});
    // }
    List<ProductModel> mList = [];
    //List<Autogenerated> mList = [];
      ...
      if (responseData['status'] == "success") {
        if (productData.length > 0) {
          ...
          for (int i = 0; i < productData.length; i++) {
            ...
            item.productKeyword = itemData['product_keywords'];
  ...
  void initState() {
    ...
    print("freshProducts..." + _freshProductList.toString());
    _listOfferSlider = [];
    _getOfferSlider();
    super.initState();
  }
        ...
        IconButton(
          ...
          onPressed: () {
            ...
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => Search(agent: isAgent),
              ),
  ...
  _agentLoad(String prefs) {
    print("Prefs Dta..." + prefs.toString());
    if (prefs != "null" && prefs == "DI") {
      //setState(() {
      isAgent = true;
      //});
    } else {
...
//    FreshNewItem(
//       {Key key,
//       @required Future<Autogenerated> freshCategories,
//       String deviceId,
//       bool isAgent,
//       final Function() notifyCart})
//       : freshCategories = freshCategories,deviceId = deviceId,isAgent = isAgent,notifyCart = notifyCart(), super(key: key);
//    final Future<Autogenerated> freshCategories;
//    String deviceId;
//    bool isAgent;
//    Function() notifyCart;
//   // FreshNewItem(
//   //     this.freshCategories, this.deviceId, this.isAgent, this.notifyCart);
//   @override
//   Widget build(BuildContext context) {
//     return
//     Container(
...
//                                     addAutomaticKeepAlives: false,
//                                     itemBuilder: (context, int index) {
//                                       Productdata item = freshItems[index];
//                                       return Padding(
//                                         padding: const EdgeInsets.only(
//                                             right: 8.0, top: 20.0),
//                                         child: FreshItem(
